...
#define	extent_dss_postfork_child JEMALLOC_N(extent_dss_postfork_child)
#define	extent_dss_postfork_parent JEMALLOC_N(extent_dss_postfork_parent)
#define	extent_dss_prec_get JEMALLOC_N(extent_dss_prec_get)
#define	extent_dss_prec_set JEMALLOC_N(extent_dss_prec_set)
#define	extent_dss_prefork JEMALLOC_N(extent_dss_prefork)
...
#define	extent_postfork_parent JEMALLOC_N(extent_postfork_parent)
#define	extent_prefork JEMALLOC_N(extent_prefork)
